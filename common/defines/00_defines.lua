...
NGame = {
	START_DATE = "1550.1.1.12",						-- New Era edit
	END_DATE = "1570.1.1.12",						-- New Era edit
...
NDiplomacy = {
	...
	MAX_TRUST_VALUE = 500,							-- New Era edit; Max trust value cap.
	MIN_TRUST_VALUE = -500,							-- New Era edit; Min trust value cap.
	MAX_OPINION_VALUE = 500,						-- New Era edit; Max opinion value cap.
	MIN_OPINION_VALUE = -500,						-- New Era edit; Min opinion value cap.
	...
	VERY_GOOD_OPINION = 250,						-- New Era edit; Threshold for a country that has a very good opinion of you.
	VERY_BAD_OPINION = -250,						-- New Era edit; Threshold for a country that has a very bad opinion of you.
	...
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.4,			-- New Era edit; Amount of tension generated for each sent division
	...
	TENSION_TIME_SCALE_START_DATE = "1550.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NCountry = {
	...
	POLITICAL_POWER_CAP = 10000.0,					-- New Era edit; Max amount of political power country should have
	...
	FEMALE_UNIT_LEADER_BASE_CHANCE = { -- New Era edit;
	...
	COUNTRY_LEADER_FEMALE_CHANCE = 0.01, -- New Era edit; chance for new country leaders to be female. should be set > 0 only if there are portraits/names for that country
